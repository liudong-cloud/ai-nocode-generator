package com.liud.ainocodegenerator.langgraph4j;
    ...
    public CompiledGraph<MessagesState<String>> createWorkflow() {
        try {
            return new MessagesStateGraph<String>()
                    ...
                    .addNode("resource_deduplication", ResourceDeduplicationNode.create())
                    ...
                    .addEdge("image_collector", "resource_deduplication")
                    .addEdge("resource_deduplication", "prompt_enhancer")
